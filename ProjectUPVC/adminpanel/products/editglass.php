                            ...
                            <div class="panel-body">     
                                <table class="table sliders">
                                    ...
                                    <tbody style="display: flex; flex-direction: row;">   
                                        <tr>
                                            <td><div style="margin-right: 20px;"><span style=" color: red; font-size: 15px;">*</span>حالت</div></td>
                                            <td>                                                   
                                                <select name="TypesKind" id="TypesKind" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;" required title="انتخاب مقداری از این فیلد الزامی است">
                                                     ...
                                                     <?php
                                                            ...
                                                            while ($Kind = mysqli_fetch_array($all_Item, MYSQLI_ASSOC)) {
                                                                $selected = ($Kind['Id'] == $rows['TypesKind']) ? 'selected' : ''; // بررسی برابری مقدار قبلی با مقدار فعلی
                                                                echo "<option value='" . $Kind['Id'] . "' " . $selected . ">" . $Kind['Type'] . "</option>";
                                                            }
                                                        ?>
                                        ...
                                        <tr>
                                            <td><div style="margin-right: 50px;"><span style=" color: red; font-size: 15px;">*</span>نوع محصول</div></td>
                                            <td>                                                   
