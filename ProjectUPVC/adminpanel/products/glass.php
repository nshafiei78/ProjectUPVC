                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">     
                                <table class="table sliders">
                                    <form class="form-horizontal" role="form" method = "post" action="insert.php?kind_id=2&page=glass.php"  enctype="multipart/form-data">
                                        
                                    <tbody style="display: flex; flex-direction: row;">   
                                         <tr>
                                          <td><div style="margin-right: 15px;"><span style=" color: red; font-size: 15px;">*</span>حالت</div></td>
                                          <td><select name="TypesKind" id="TypesKind" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;" required title="انتخاب مقداری از این فیلد الزامی است.">
                                              <option value="">بدون انتخاب</option>
                                              <?php
                                              $sql = "SELECT * FROM `typeskind` WHERE Id!=0";
                                              $all_Item = mysqli_query( $conn, $sql );
                                              while ( $Kind = mysqli_fetch_array(
                                                  $all_Item, MYSQLI_ASSOC ) ): ;
                                              ?>
                                              <option 
                                                value="<?php echo $Kind["Id"];?>"> <?php echo $Kind["Type"];?> </option>
                                              <?php
                                              endwhile;
                                        ...
                                        <tr>
                                            <td><div style="margin-right: 80px;"><span style=" color: red; font-size: 15px;">*</span>نوع شیشه‌ها</div></td>
                                            <td>                                                   
                                                <select name="TypeId" id="TypeId" class="form-control bound-s" style="margin-right: 10px; width: 200px; height: 40px;" required title="انتخاب مقداری از این فیلد الزا">
                                                      <option value="">بدون انتخاب</option>
                                                    <?php
                                                        $sql = "SELECT * FROM `types` WHERE KindId = 2";
	                                                    $all_Item = mysqli_query($conn,$sql);
                                                      while ( $Kind = mysqli_fetch_array(
                                                          $all_Item, MYSQLI_ASSOC ) ): ;
                                                      ?>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <td>  
                                                ...
                                                <td> 
                                                <img id="uploaded-image" width="100" height="50" style="margin-right: -50px;" />
                            ...
                            <header class="panel-heading">
                                لیست شیشه‌ها
                                                 ...
                                                 <form class="form-horizontal" role="form" method="post" action="glass.php" enctype="multipart/form-data">
                                         <table class="table sliders">
                                              <tbody style="display: flex; flex-direction: row;">
                                              <tr>
                                                  <td><div style="margin-right: 30px;">حالت</div></td>
                                                  <td><select name="TypesKindId_Search" id="TypesKindId_Search" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;">
                                                      <option value="">بدون انتخاب</option>
                                                      <?php
                                                      $sql = "SELECT * FROM `typeskind` WHERE Id!=0";
                                                      $all_Item = mysqli_query( $conn, $sql );
                                                      ...
                                                      <tr>
                                                        <td><div style="margin-right: 50px;">نوع شیشه‌ها</div></td>
                            ...
                            <table class="table table-striped border-top" id="sample_1 " style="text-align: center; margin-top: 50px;">
                                ...
                                <thead>
                                    <tr style="text-align: center;">
                                        ...
                                        <th class="hidden-phone" style="text-align: center;">حالت</th>
                                ...
                                <tbody>
                                    <?php
                                        if (isset($_POST['search_btn']))
                                        {
                                            ...
                                            $TypesKindId_Search = $_POST[ 'TypesKindId_Search' ];
                                        }
                                       
                                       elseif(isset($_POST['clear_btn']))
                                            {
                                            $TypeId_Search = null;
                                            $TypesKindId_Search = null;
                                            }
                                              else
                                              {
                                                   $TypeId_Search = null;
                                            ...
                                            {
                                                 $where_query .=" and product.TypId =$TypeId_Search ";
                                            }


                                                if( $TypesKindId_Search != null)
                                            {
                                                 $where_query .=" and product.TypesKind= $TypesKindId_Search";
                                            }
                                            ...
                                            WHERE product.KindId =2 " .$where_query ;
                                    ...
                                    ?>
                                      <tr class="odd gradeX">
                                        <td></td>
                                        <td><?=$i;?></td>
                                        <td class="hidden-phone"><?=$rows['TypesKind'];?></td>
                                        ...
                                        <td >
                                            <a href='editglass.php?id=<?= $rows['Id'];?>&page=glass.php&kind_id=2'>
                                          <button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button>
                                            </a>
                                            
                                                <a href='delete.php?id=<?= $rows['Id'];?>&page=glass.php'>
