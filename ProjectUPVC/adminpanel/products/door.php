...
<section id="main-content">
  <section class="wrapper"> 
    ...
    <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading"> درب‌ها </header>
      <div class="panel-body">
        <table class="table sliders">
          <form class="form-horizontal" role="form" method = "post" action="insert.php?kind_id=1&page=door.php"  enctype="multipart/form-data">
          
          <tbody style="display: flex; flex-direction: row;">
           
              <tr>
              <td><div style="margin-right: 10px;"><span style=" color: red; font-size: 15px;">*</span>نوع درب‌ها</div></td>
              <td><select name="TypeId" id="TypeId" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;" required title="انتخاب مقداری از این فیلد الزامی است">
                  ...
                  ?>
                  <option 
                    value="<?php echo $Kind["Id"];?>"> <?php echo $Kind["Title"];?> </option>
                  <?php
            ...
            <td>  
                ...
                <input type="file" class="file-pos" name="Picture" style="margin-right: 150px;">
                   ...
                   <td> 
                    ...
                    <img id="uploaded-image" width="100" height="50" style="margin-right: -30px; border: 2px solid white;"  />
          ...
          <div class="form-group">
            <td><div class="form-group">
              ...
              <div class="col-lg-10">
              <textarea name="Discription" id="Discriptionid" class="form-control" cols="10" rows="5" style= "width: 967px; height: 108px;"></textarea></td>
          </div>
		  ...
		  <?php
					...
					?>
						<p style="text-align: center"> 
						   <font face='yekan, yekan,"Times New Roman"' size='+1' color='#ff0000' ><?php echo $message;?></font> 
						</p>
					<?php
					}
					?>
    ...
    <section class="panel" style="padding-bottom: 30px" >
      ...
      <form class="form-horizontal" role="form" method="post" action="door.php" enctype="multipart/form-data">
        <table class="table sliders">
            <tbody style="display: flex; flex-direction: row;">
             
                <tr>
                <td><div style="margin-right: 30px;">نوع درب‌ها</div></td>
      ...
      <table class="table table-striped border-top" id="sample_1 " style="text-align: center; margin-top: 50px;">
        ...
        <tbody>
          ...
          <tr class="odd gradeX">
            ...
            <td class="center hidden-phone"><?=$rows['Discription'];?></td>
            <td class="center hidden-phone"><img src="<?=$rows['Picture'];?>"width="100" height="50"/></td>
            <td >
                <a href='edit.php?id=<?= $rows['Id']; ?>&page=door.php&kind_id=1'>
                  <button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button>
                </a>
                <a href='delete.php?id=<?= $rows['Id'];?>&page=door.php'>
