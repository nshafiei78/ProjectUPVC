...
<section id="main-content">
  <section class="wrapper"> 
    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          <header class="panel-heading"> اطلاعات مشتری </header>
          <div class="panel-body">
           
			<form class="form-horizontal" role="form" method = "post" action="updateinfocustomers.php?page=infocustomers.php"  enctype="multipart/form-data">
			  <div class="form-group" style="margin-top:50px;">
				...
				<div class="col-lg-10">
					<div class="row">
						<div class="col-lg-2">
								<input type="text" name="FName" id="FNameId" class="form-control" value=" <?=$rows['FirstName'];?>" required title="پر کردن این فیلد الزامی است. ">
						</div>
						...
						<div class="col-lg-2">
								<input type="text" name="LName" id="LNameId" class="form-control" value=" <?=$rows['LastName'];?>" required title="پر کردن این فیلد الزامی است. ">
						</div>
						...
						<div class="col-lg-2">
								<input type="tel" id="PhoneId" name="Phone" placeholder="09*********" pattern="[0][9][0-9]{9}" required title="شماره همراه را مطابق الگو وارد کنید." class="form-control" value=" <?=$rows['Phone'];?>">
						</div>
						<div class="form-group" style="margin-top:50px; margin-right: -70px;">
						<label class="col-lg-2 control-label" style="width: 5%;"><span style=" color: red; font-size: 15px;">*</span>آدرس</label>
							<div class="col-lg-10">
								<div class="row">
									<div class="col-lg-2">
									<textarea name="َAddress" id="َAddressid" class="form-control" cols="10" rows="5" style= "width: 907px; height: 81px; margin-right: 5px;"required title="پر کردن این فیلد الزامی است. "><?php echo $rows['Address'];?></textarea>
        ...
        <section class="panel" style="padding-bottom: 30px" >
          ...
          <header class="panel-heading"> لیست مشتریان </header>
