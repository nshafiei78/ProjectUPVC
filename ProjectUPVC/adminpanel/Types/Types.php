                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                    <form class="form-horizontal" role="form" method = "post" action="insert.php?page=Types.php"  enctype="multipart/form-data">
                                            <div class="form-group" style="margin-top:50px;">
              									<div class="col-lg-10">
													...
													<div class="col-lg-2">
															<input type="text" name="Title" id="Title" class="form-control" style="margin-right: 23px;" required title="پر کردن این فیلد الزامی است. ">
													</div>
														<label class="col-lg-2 control-label" style="width: 11%; margin-right: 60px; margin-top: -5px; margin-left: -18px;"><span style=" color: red; font-size: 15px;">*</span>نوع محصول</label>
													   <select name="KindId" id="KindId" class="form-control bound-s" style="margin-right: 30px; width: 15%; height: 35px;" required title="پر کردن این فیلد الزامی است. ">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                      <tr class="odd gradeX">
                                        ...
                                        <td >
                                            <a href='edit.php?id=<?= $rows['Id'];?>&page=Types.php'>
                                          		<button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button>
                                            </a>
                                            
                                            <a href='delete.php?id=<?= $rows['Id'];?>&page=Types.php'>
