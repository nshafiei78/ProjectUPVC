                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                    <form class="form-horizontal" role="form" method = "post" action="insert.php?page=AdminUser.php"  enctype="multipart/form-data">
                                            <div class="form-group" style="margin-top:50px;">
                    							<label class="col-lg-2 control-label" style="width: 8%; margin-right: 60px; margin-top: -5px; margin-left: -50px;"><span style=" color: red; font-size: 15px;">*</span>نام</label>
              									<div class="col-lg-10">
                									<div class="row">
                  						<div class="col-lg-2">
                    							<input type="text" name="Name" id="Name" class="form-control" required title="پر کردن این فیلد الزامی است. ">
                  						</div>
										...
										<div class="col-lg-2">
                    							<input type="text" name="LastName" id="LastName" class="form-control" style="margin-right: 23px;" required title="پر کردن این فیلد الزامی است. ">
                  						</div>
										<label class="col-lg-2 control-label" style="width: 8%; margin-right: 60px; margin-top: -5px; margin-left: -18px;"><span style=" color: red; font-size: 15px;">*</span>نام‌کاربری</label>
										<div class="col-lg-2">
                    							<input type="text" name="Username" id="Username" class="form-control" pattern="[A-Za-z].{3,}" required  title="نام کاربری باید فقط شامل حروف انگلیسی و طول آن بزرگتر از 3 باشد. ">
                  						</div>
                					</div>
              									</div>
            								</div>
										  <div class="form-group" style="margin-top:50px;">
                    							<label class="col-lg-2 control-label" style="width: 6%; margin-right: 60px; margin-top: -5px; margin-left: -18px;"><span style=" color: red; font-size: 15px;">*</span>رمز عبور</label>
              									<div class="col-lg-10">
                									<div class="row">
														<div class="col-lg-2">
															<input type="password" name="password" id="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required title="رمز عبور باید حداقل یک عدد و یک حرف بزرگ و کوچک و حداقل 8 کاراکتر یا بیشتر داشته باشد.">
															
                  										</div>
														<label class="col-lg-2 control-label" style="width: 10%; margin-right: 57px; margin-top: -5px; margin-left: -18px;"><span style=" color: red; font-size: 15px;">*</span>تکرار رمز عبور </label>
														<div class="col-lg-2">
