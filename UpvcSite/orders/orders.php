...
<body>
	...
	<div class="page">
		...
		<section class="bg-gray-dark">
			<section class="section parallax-container" data-parallax-img="./images/headerimageorder1.PNG" style="width: 1519.2px; height: 600px;">
							...
							<div class="container">
								<div class="row justify-content-sm-center">
									<div class="col-md-10 col-xl-8">
										<h2 class="heading-decorated">سفارشات</h2>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="container">
				<div class="row row-50">
					...
					<div class="col-md-7 col-lg-8">
						<h4 class="heading-decorated">ثبت سفارش</h4>
						<!-- RD Mailform-->
						
                              <form class="form-horizontal" role="form" method = "post" action="insert.php?page=../pageorginal/index.php&id=<?php echo $iduser; ?>"  enctype="multipart/form-data">
							
                            <div class="form-wrap form-wrap_icon ">
								
								<label class="form-label" for="contact-name">محصول</label>
                                <select name="Products" id="ProductsId" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;"required title="پر کردن این فیلد الزامی است. ">
                             ...
                             <div class="form-wrap form-wrap_icon ">
								<label class="form-label" for="contact-name">نوع محصول</label>
                                 <select name="TypeProducts" id="TypeProductsId" class="form-control bound-s" style="margin-right: 30px; width: 200px; height: 40px;"required title="پر کردن این فیلد الزامی است. ">
                            ...
                            <div class="form-wrap form-wrap_icon">
								<input class="form-input" id="contact-name" type="text" name="Dimensions">
								<label class="form-label" for="contact-name">ابعاد</label>
							</div>
                            <div class="form-wrap form-wrap_icon ">
								<input class="form-input" id="contact-name" type="text" name="Discription">
								<label class="form-label" for="contact-name">توضیحات</label>
							</div>
