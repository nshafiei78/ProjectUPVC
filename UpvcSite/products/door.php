...
<body>
	...
	<div class="page">
		...
		<section class="bg-gray-dark">
			<section class="section parallax-container" data-parallax-img="./images/headerimagedoor1.PNG">
							...
							<div class="container">
								<div class="row justify-content-sm-center">
									<div class="col-md-10 col-xl-8">
										<h2 class="heading-decorated" style="color:black">انواع درب‌ها</h2>
									</div>
								</div>
							</div>
						</div>
