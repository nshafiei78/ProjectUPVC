...
<body>
	...
	<div class="page">
		...
		<section class="bg-gray-dark">
			<section class="section parallax-container" data-parallax-img="./images/headerimageglass1.PNG">
							...
							<div class="container">
								<div class="row justify-content-sm-center">
									<div class="col-md-10 col-xl-8">
										<h2 class="heading-decorated" style="color:black">انواع شیشه‌ها</h2>
									</div>
								</div>
							</div>
						</div>
...
امروزه از انواع شیشه برای ساخت لوازم تزئینی، ظروف، درب، پنجره، نمای ساختمان و بسیاری از موارد دیگر استفاده می شود. هر نوع از شیشه، با توجه به ویژگی های مخصوصی که دارد، در موارد مختلفی به کار برده می شود. به طور مثال از شیشه سکوریت یا میرال، بیشتر در مواردی استفاده می شود که نیاز به ایمنی و مقاومت بالا می باشد.                 </p>
				...
				<p align="justify">
با پیشرفت تکنولوژی، در صنعت شیشه نیز تغییرات بسیاری ایجاد شده است و امروزه از روش های مختلفی برای ساخت این ماده پرکاربرد استفاده می شود. به طور کلی اصلی ترین مواد تشکیل دهنده شیشه، سیلیس، کربنات سدیم و آهک می باشند. شیشه به دلیل ویژگی های منحصر به فردی که دارد همواره مورد توجه معماران و طراحان دکوراسیون قرار گرفته است.                </p>
              
				<p align="justify">
چه در زمان هایی که به ایمنی بالا نیاز داریم و چه در مواقعی که احتیاج به ایجاد زیبایی داریم، شیشه به کمک ما می آید. برای انتخاب نوع شیشه، لازم است ابتدا محل نصب آن را در نظر بگیرید و سپس با توجه به ویژگی هایی مانند، استحکام، زیبایی، عایق صوتی، امنیت و …. شیشه مورد نظر خود را انتخاب کنید.                 </p>
			...
			<div class="container-fluid container-flex">
				<div class="row no-gutters" data-photo-swipe-gallery="gallery">
                     <?php
                        ...
                        $Picture = [];
                        $Discription = [];
                        $sql=mysqli_query($conn,"SELECT product.Id as Id,CONCAT(kind.`Name`,' ',types.Title) as Title,
                                                 product.Discription as Discription,product.Picture as Picture,
                                                 product.KindId as kindId FROM product 
                                                 JOIN kind ON kind.Id = product.KindId
                                                 JOIN types ON types.Id=product.TypId
                                                 WHERE product.KindId=2");
                        $i=0;
                        ...
                        {  
                            ...
                            $string="../../ProjectUPVC/adminpanel/products/";
