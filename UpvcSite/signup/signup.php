				...
				<div class="row row-50">
					...
					<div class="col-md-7 col-lg-8">
						...
						<!-- RD Mailform-->
                              ...
                              <form class="form-horizontal" role="form" method = "post" action="signupusers.php?page=../signin/signin.php"  enctype="multipart/form-data">
							<div class="form-wrap form-wrap_icon linear-icon-man">
								<input class="form-input" id="contact-name" type="text" name="name" data-constraints="@Required">
								<label class="form-label" for="contact-name">نام</label>
							</div>
                            <div class="form-wrap form-wrap_icon linear-icon-man">
								<input class="form-input" id="contact-name" type="text" name="familyname" data-constraints="@Required">
								<label class="form-label" for="contact-name">نام خانوادگی</label>
							</div>
                            <div class="form-wrap form-wrap_icon linear-icon-man">
                            ...
                            <div class="form-wrap form-wrap_icon linear-icon-man">
								<input class="form-input" id="contact-name" type="password" name="repeatpassword"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
								<label class="form-label" for="contact-name">رمز عبور</label>
							</div>
