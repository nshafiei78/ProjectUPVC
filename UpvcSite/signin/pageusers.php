                   ...
                   include("../templates/inc_template/headerup.php");
					...
					<div class="rd-navbar-inner rd-navbar-search-wrap">
						...
						<div class="rd-navbar-nav-wrap rd-navbar-search_not-collapsable">
                            ...
                            <?php
                             //$iduser = $_GET['id'];
                            include("../templates/inc_template/menuusers.php");
		...
		<section>
			<div class="swiper-container swiper-slider swiper-slider_fullheight bg-gray-dark" data-simulate-touch="false" data-loop="true" data-autoplay="5000">
				<div class="swiper-wrapper">
					<div class="swiper-slide" data-slide-bg="../pageorginal/images/image1.jpg">
					...
					<div class="swiper-slide text-right" data-slide-bg="../pageorginal/images/image2.jpg">
...
پروفیل UPVC از 62- تا 81+ درجه سانتی گراد هیچگونه تغییری از نظر رنگ پریدگی یا انحنا و خمش در آن به وجود نخواهد آمد.
		...
		<section class="bg-gray-lighter object-wrap">
			...
			<div class="object-wrap__body object-wrap__body-sizing-1 object-wrap__body-md-right bg-image" style="background-image: url(../signup/images/history.jpg);"></div>
		</section>
		<!-- running projects-->
		<section class="section-md bg-default text-center">
			<div class="container">
